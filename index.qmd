...
```
::: notes
- Acá es importante recalcar que si por ejemplo ponemos la condición "corto" antes que "largo" y "mediano", entonces todos los tramos nos van a quedar como "corto" porque el orden importa.
:::
...
9. Utilizando funciones anidadas:
  ...
  - Filtre las filas donde "tramo_superficie" sea igual a "grande" y "anio" igual a 1991.
